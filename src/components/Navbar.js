export default function Navbar() {
  return (
    <header className="fixed top-0 left-0 w-full flex justify-between items-center py-4 px-4 bg-transparent z-50">
      ...
      <nav className="flex justify-around items-center w-[685px] h-[70px] rounded-[40px] bg-white shadow-md flex-shrink-0">
        ...
        <a href="/about" className="flex justify-center items-center w-[71px] h-[30px] text-[#004E64] border-b-4 border-[#004E64] text-[24px] font-description font-bold leading-normal no-underline flex-shrink-0">
          About
        </a>
        <a href="/verify" className="flex justify-center items-center w-[71px] h-[30px] text-black text-[24px] font-description font-bold leading-normal no-underline flex-shrink-0">
          Verify
        </a>
        <a href="/categories" className="flex justify-center items-center w-[71px] h-[30px] text-black text-[24px] font-description font-bold leading-normal no-underline flex-shrink-0">
          Categories
        </a>
      </nav>
