...
const categories = [
  { id: 1, title: 'Obat Asma',       icon: '/categories/ByDisease/CCF01.png',    href: '/categories/medicine/categories/Obat Asma' },
  { id: 2, title: 'Perawatan Asma',  icon: '/categories/ByDisease/BD01.png',     href: '/categories/medicine/categories/Perawatan Asma' },
  { id: 3, title: 'Inhaler',         icon: '/categories/ByDisease/THT01.png',    href: '/categories/medicine/categories/Inhaler' },
];
