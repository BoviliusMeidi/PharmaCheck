...
const categories = [
  { id: 1, title: 'Susu Dewasa',          icon: '/categories/ByDisease/CCF01.png',    href: '/categories/non-medicine/categories/Heart & Immune' },
  ...
  { id: 3, title: 'Susu Medis Khusus',    icon: '/categories/ByDisease/THT01.png',    href: '/categories/medicine/categories/Vitamins & Supplements' },
  { id: 4, title: 'Lainnya',              icon: '/categories/ByDisease/THT01.png',    href: '/categories/medicine/categories/Vitamins & Supplements' },
    ...
    <div className="relative bg-[#FCF7F8] min-h-screen flex flex-col">
        ...
        <div className="flex-1 flex justify-center px-8">
          <div className="py-10 px-8 max-w-[1083px] text-center">
            <h1 className="font-title text-[80px]">Susu Segala Umur</h1>
